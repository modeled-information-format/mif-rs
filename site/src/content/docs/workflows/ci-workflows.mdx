---
title: "CI Workflows"
description: "Continuous integration workflow architecture and configuration."
---
...
the docs site:
[https://attested-delivery.github.io/docs/concepts/11-verify-every-external-fetch/](https://attested-delivery.github.io/docs/concepts/11-verify-every-external-fetch/).
